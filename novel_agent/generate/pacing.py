...
_DIRECTIVES: dict[BeatType, str] = {
    BeatType.SETUP: (
        "本章为铺垫节拍：通过具体事件、对话和人物选择交代必要信息、推进关系、埋下伏笔，"
        "为后续冲突蓄力。铺垫不等于停下来写景或介绍人物；可不强求爽点，但本章必须有实际进展，"
        "章末留下牵引力。"
    ),
    BeatType.BUILD: (
    ...
    BeatType.AFTERMATH: (
        "本章为余韵节拍：高潮之后用行动和对话结算战果、处理遗留、呈现关系变化，"
        "并自然抛出指向下一段的新钩子。节奏可稍缓，但不能用大段环境或心理描写代替剧情进展。"
    ),
}
